...
public:
    ...
    struct MouseWheelScrolled
    {
        ...
        Vector2i pos; //!< Position of the mouse pointer, relative to the top left of the owner window
    };
    ...
    struct JoystickMoved
    {
        ...
        float          pos{};   //!< New position on the axis (in range [-100 .. 100])
    };
    ...
    struct TouchBegan
    {
        ...
        Vector2i     pos; //!< Start position of the touch, relative to the top left of the owner window
    };
    ...
    {
        unsigned int finger{}; //!< Index of the finger in case of multi-touch events
        Vector2i     pos; //!< Current position of the touch, relative to the top left of the owner window
    };
    ...
    {
        unsigned int finger{}; //!< Index of the finger in case of multi-touch events
        Vector2i     pos; //!< Final position of the touch, relative to the top left of the owner window
    };
