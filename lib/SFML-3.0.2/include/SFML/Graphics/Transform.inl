...
constexpr FloatRect Transform::transformRect(const FloatRect& rectangle) const
{
    ...
    const std::array points = {transformPoint(rectangle.pos),
                               transformPoint(rectangle.pos + Vector2f(0.f, rectangle.size.y)),
                               transformPoint(rectangle.pos + Vector2f(rectangle.size.x, 0.f)),
                               transformPoint(rectangle.pos + rectangle.size)};
